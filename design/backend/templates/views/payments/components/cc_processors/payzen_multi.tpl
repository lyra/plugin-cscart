...
<fieldset>
    <p style="font-size: 12px; font-style: italic; color: #666666;">{__("payzen_multi_warning")}</p>
</fieldset>
{/if}
...
<fieldset>
    <legend style="margin-bottom: 0;">
        <font style="font-size: 14px; font-weight: bold;">{__("payzen_multi_options")}</font>
    </legend>

    <div class="control-group">
        <label class="control-label" for="payzen_multi_option_first">{__("payzen_multi_first")}</label>
        <div class="controls">
            <input type="number" name="payment_data[processor_params][payzen_multi_first]" id="payzen_multi_first" style="width: 100px;" value="{$processor_params.payzen_multi_first}" min="1" max="99">
            <p style="font-size: 12px; font-style: italic; color: #666666;">{__("payzen_multi_first_desc")}</p>
        </div>
    </div>

    <div class="control-group">
        <label class="control-label" for="payzen_multi_option_count">{__("payzen_multi_count")}</label>
        <div class="controls">
            <input type="number" name="payment_data[processor_params][payzen_multi_count]" id="payzen_multi_count" style="width: 100px;" value="{$processor_params.payzen_multi_count}" min="1">
            <p style="font-size: 12px; font-style: italic; color: #666666;">{__("payzen_multi_count_desc")}</p>
        </div>
    </div>

    <div class="control-group">
        <label class="control-label" for="payzen_multi_option_period">{__("payzen_multi_period")}</label>
        <div class="controls">
            <input type="number" name="payment_data[processor_params][payzen_multi_period]" id="payzen_multi_period" style="width: 100px;" value="{$processor_params.payzen_multi_period}" min="1">
            <p style="font-size: 12px; font-style: italic; color: #666666;">{__("payzen_multi_period_desc")}</p>
        </div>
    </div>
</fieldset>
